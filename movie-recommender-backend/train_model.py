...
def get_data_from_str_literal(obj):
    try:
...
if __name__ == "__main__":
    ...
    movies['genres'] = movies['genres'].apply(get_data_from_str_literal)
    movies['keywords'] = movies['keywords'].apply(get_data_from_str_literal)
    movies['cast'] = movies['cast'].apply(lambda x: get_data_from_str_literal(x)[:3])
